...
import com.example.rworksample00026.databinding.ActivityExperienceFormFixBinding
import com.example.rworksample00026.ui.util.ScopedAppActivity
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch
import kotlinx.coroutines.withContext

class ExperienceFormFixActivity : ScopedAppActivity() {

    private lateinit var binding: ActivityExperienceFormFixBinding
    private val viewModel: ExperienceViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityExperienceFormFixBinding.inflate(layoutInflater)
        ...
        launch (Dispatchers.IO){
            ...
            launch (Dispatchers.Main){
                ...
                binding.editdesiredDateFirstCandidate.setText(data.map{it.desiredDateFirstCandidate}[0].toString())
                binding.editdesiredDateSecondCandidate.setText(data.map{it.desiredDateSecondCandidate}[0].toString())
                binding.editdesiredDateThirdCandidate.setText(data.map{it.desiredDateThirdCandidate}[0].toString())
        ...
        val desiredDateFirstCandidate = binding.editdesiredDateFirstCandidate
        val desiredDateSecondCandidate = binding.editdesiredDateSecondCandidate
        val desiredDateThirdCandidate = binding.editdesiredDateThirdCandidate
        ...
        desiredDateFirstCandidate.addTextChangedListener(object: TextWatcher {
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {
            ...
            override fun afterTextChanged(s: Editable?) {
                launch{ withContext(Dispatchers.Default){ viewModel.updateDesiredDateFirstCandidate(s.toString()) } }

            }
        })
        desiredDateSecondCandidate.addTextChangedListener(object: TextWatcher {
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {
            ...
            override fun afterTextChanged(s: Editable?) {
                launch{ withContext(Dispatchers.Default){ viewModel.updateDesiredDateSecondCandidate(s.toString()) } }

            }
        })
        desiredDateThirdCandidate.addTextChangedListener(object: TextWatcher {
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {
            ...
            override fun afterTextChanged(s: Editable?) {
                launch{ withContext(Dispatchers.Default){ viewModel.updateDesiredDateThirdCandidate(s.toString()) } }
        ...
        binding.Btn.setOnClickListener (object : View.OnClickListener{
            override fun onClick(v: View?) {
                val intent = Intent(this@ExperienceFormFixActivity, ExperienceFormConfirmActivity::class.java)
