...
import com.example.rworksample00026.databinding.ActivityRequestDocumentsFormSecondBinding
...
class RequestDocumentsFormSecondActivity : ScopedAppActivity() {

    private lateinit var binding: ActivityRequestDocumentsFormSecondBinding
    private val viewModel: RequestDocumentsViewModel by viewModels()
    private val userViewModel: UserViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityRequestDocumentsFormSecondBinding.inflate(layoutInflater)
        ...
        binding.nextPageBtn.setOnClickListener (object : View.OnClickListener{
            override fun onClick(v: View?) {
                ...
                val intent = Intent(this@RequestDocumentsFormSecondActivity, RequestDocumentsFormThirdActivity::class.java)
